...
const Calculator = {
    ...
    function Input_Decimal(dot) {
        ...
        // dosen't cause bug in your operation
        if (Calculator.Wait_Second_Operand === ture) return;
        if (!Calculator.Display_Value.includes(dot)) {
        //we are sating that id the Diplay_Value does not contain a decimal point 
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exist and if WAit_Second_operand is ture.
